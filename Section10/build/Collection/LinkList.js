...
NewLinkList.insertAtStart(10);
NewLinkList.insertAtStart(26);
NewLinkList.insertAtStart(4);
NewLinkList.insertAtEnd(-54);
NewLinkList.insertAtEnd(-20);
NewLinkList.insertAtEnd(-60);
NewLinkList.display();
